    ...
    [
        ...
        for (args, *files) in [
            ...
            (
                ...
                FIXTURE_DIR
                / "psselect"
                / "psselect-options-and-complex-pagerange-expected",
            ),
            ...
            (
                ...
                FIXTURE_DIR
                / "psselect"
                / "psselect-individual-pages-and-dash-p-expected",
            ),
            (
                ["-p", "1-5"],
                FIXTURE_DIR / "a4-1",
                ...
                FIXTURE_DIR
                / "psselect"
                / "psselect-invalid-pagerange-expected-stderr.txt",
            ),
            (
                ["5-15"],
                FIXTURE_DIR / "a4-20",
...
def test_psnup_texlive(
    capsys: CaptureFixture[str], files: Tuple[Path, ...], file_type: str
) -> None:
