...
def get_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        description='Select pages from a PDF document.',
...
''',
    ...
    parser.add_argument('alt_pages', metavar='PAGES', nargs='?',
...
def main(argv: List[str]=sys.argv[1:]) -> None: # pylint: disable=dangerous-default-value
    ...
    if args.alt_pages is not None:
        if args.pages is None and args.even is False and args.odd is False and args.reverse is False:
